...
# Assign systems: first 5 = A/B, last 5 = C
df["System"] = ["System A or B"] * 5 + ["System C"] * 5

# Define valid loading categories
valid_categories = [
    'A/domestic',
    'B/car parking',
    'C/pedestrian',
...
load_category = st.selectbox("Select Loading Category", valid_categories)
cbr_value = st.selectbox("Select CBR Value", ["1%", "2%", "3%", "4%", "5%", "8%", "10%", "15%"])

# Map user-facing name to internal key
system_key = "System C" if "System C" in system else "System A or B"
